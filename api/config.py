...
_SETTINGS_DEFAULTS = {
    ...
    "chat_activity_display_mode": "compact_worklog",  # compact_worklog | turn_worklog | transparent_stream | hide_all_activity
...
def load_settings() -> dict:
    ...
    if isinstance(stored, dict):
        ...
        # Virtualize_transcript default-on migration.
        # The feature shipped opt-OUT/default-on in #4325, was force-flipped
        # OFF for everyone in #4343 due to scroll-up flicker, and is now
        # default-ON again — #4346 Phase B resolved the flicker root cause
        # (footer-jitter suppression during virtual-scroll measurement).
        # The old force-off migration is retired: we no longer reset stored
        # True values. Users who explicitly set False keep their preference.
        # New users and users who never touched the setting get the True default.
...
_SETTINGS_ENUM_VALUES = {
    ...
    "chat_activity_display_mode": {"compact_worklog", "turn_worklog", "transparent_stream", "hide_all_activity"},
