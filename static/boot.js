...
(async()=>{
  ...
  try{
    ...
    window._chatActivityDisplayMode=s.chat_activity_display_mode==='transparent_stream'||s.chat_activity_display_mode==='hide_all_activity'||s.chat_activity_display_mode==='turn_worklog'
